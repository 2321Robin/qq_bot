...
async def handle_roco_pet(event: GroupMessageEvent, args: Message = CommandArg()) -> None:
    ...
    await finish_with_send_errors_logged(roco_pet_command, _format_pet_card_message(record))
...
async def handle_roco_mention_pet(event: GroupMessageEvent) -> None:
    ...
    if record is not None:
        ...
        await finish_with_send_errors_logged(roco_mention_pet, _format_pet_card_message(record))
